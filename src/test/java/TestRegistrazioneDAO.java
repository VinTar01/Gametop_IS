...
public class TestRegistrazioneDAO {
    ...
    @Test
    public void TestInserisciNuovoUtente () throws SQLException {
    userDAO.doSave(utenteNonEsistente);
    assertEquals(utenteNonEsistente,userDAO.doRetrieveByKey(utenteNonEsistente.getEmail())); //se lo trovo, inserimento ok
    }
    
    @Test
    public void TestInserisciNuovoUtenteNull () throws SQLException {
    ...
    @Test
    public void TestInserisciNuovoUtenteEsistente () throws SQLException {
    ...
    assertNotEquals(utenteEsistente,userDAO.doRetrieveByKey(utenteEsistente.getEmail())); // se non lo trovo, eliminazione ok
    }
