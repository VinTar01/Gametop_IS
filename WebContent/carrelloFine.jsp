...
<meta http-equiv="cache-control" content="max-age=0" />
	...
	%>
		...
		if (window.performance && window.performance.navigation.type === window.performance.navigation.TYPE_BACK_FORWARD) {
			window.location.replace("https://localhost:8443/GametopFV/index.jsp");
		}
    </script>
...
<section class="carrello">
	...
	<h2>Prodotti nel Carrello</h2>
		...
		<tr>
			...
			<input type="text" name="id" value=<%=prod.getCodiceProdotto()%> style="display: none;">
			
			
			<td><img src="<%= prod.getCopertina()%>" onerror="this.src='./image/noimage.png'" width=75px> </td>
			<td> <a href="<%=response.encodeURL("CarrelloControl?action=deleteCart&id="+prod.getCodiceProdotto()) %>">Rimuovi</a> </td>
		</tr>
